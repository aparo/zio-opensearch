...
package zio.opensearch.searchable_snapshots
...
import zio.opensearch.searchable_snapshots.cache_stats.CacheStatsRequest
import zio.opensearch.searchable_snapshots.cache_stats.CacheStatsResponse
import zio.opensearch.searchable_snapshots.clear_cache.ClearCacheRequest
import zio.opensearch.searchable_snapshots.clear_cache.ClearCacheResponse
import zio.opensearch.searchable_snapshots.mount.MountRequest
import zio.opensearch.searchable_snapshots.mount.MountResponse
import zio.opensearch.searchable_snapshots.requests.MountRequestBody
import zio.opensearch.searchable_snapshots.stats.StatsRequest
import zio.opensearch.searchable_snapshots.stats.StatsResponse

object SearchableSnapshotsManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, SearchableSnapshotsManager] =
    ZLayer {
      for {
...
trait SearchableSnapshotsManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/searchable-snapshots-apis.html
   *
   * @param masterTimeout
