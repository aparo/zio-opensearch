...
package zio.opensearch.text_structure
...
import zio.opensearch.text_structure.find_structure.FindStructureRequest
import zio.opensearch.text_structure.find_structure.FindStructureResponse

object TextStructureManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, TextStructureManager] =
    ZLayer {
      for {
...
trait TextStructureManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/find-structure.html
   *
