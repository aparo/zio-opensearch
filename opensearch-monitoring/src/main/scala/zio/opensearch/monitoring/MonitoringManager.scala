...
package zio.opensearch.monitoring
...
import zio.opensearch.monitoring.bulk.BulkRequest
import zio.opensearch.monitoring.bulk.BulkResponse

object MonitoringManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, MonitoringManager] =
    ZLayer {
      for {
...
trait MonitoringManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/monitor-opensearch-cluster.html
   *
   * @param `type`
@deprecated 7.0.0
