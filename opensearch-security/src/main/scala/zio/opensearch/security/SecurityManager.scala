...
import zio.opensearch.security.activate_user_profile.ActivateUserProfileRequest
import zio.opensearch.security.activate_user_profile.ActivateUserProfileResponse
import zio.opensearch.security.authenticate.AuthenticateRequest
import zio.opensearch.security.authenticate.AuthenticateResponse
import zio.opensearch.security.bulk_update_api_keys.BulkUpdateApiKeysRequest
import zio.opensearch.security.bulk_update_api_keys.BulkUpdateApiKeysResponse
import zio.opensearch.security.change_password.ChangePasswordRequest
import zio.opensearch.security.change_password.ChangePasswordResponse
import zio.opensearch.security.clear_api_key_cache.ClearApiKeyCacheRequest
import zio.opensearch.security.clear_api_key_cache.ClearApiKeyCacheResponse
import zio.opensearch.security.clear_cached_privileges.ClearCachedPrivilegesRequest
import zio.opensearch.security.clear_cached_privileges.ClearCachedPrivilegesResponse
import zio.opensearch.security.clear_cached_realms.ClearCachedRealmsRequest
import zio.opensearch.security.clear_cached_realms.ClearCachedRealmsResponse
import zio.opensearch.security.clear_cached_roles.ClearCachedRolesRequest
import zio.opensearch.security.clear_cached_roles.ClearCachedRolesResponse
import zio.opensearch.security.clear_cached_service_tokens.ClearCachedServiceTokensRequest
import zio.opensearch.security.clear_cached_service_tokens.ClearCachedServiceTokensResponse
import zio.opensearch.security.create_api_key.CreateApiKeyRequest
import zio.opensearch.security.create_api_key.CreateApiKeyResponse
import zio.opensearch.security.create_service_token.CreateServiceTokenRequest
import zio.opensearch.security.create_service_token.CreateServiceTokenResponse
import zio.opensearch.security.delete_privileges.DeletePrivilegesRequest
import zio.opensearch.security.delete_privileges.DeletePrivilegesResponse
import zio.opensearch.security.delete_role.DeleteRoleRequest
import zio.opensearch.security.delete_role.DeleteRoleResponse
import zio.opensearch.security.delete_role_mapping.DeleteRoleMappingRequest
import zio.opensearch.security.delete_role_mapping.DeleteRoleMappingResponse
import zio.opensearch.security.delete_service_token.DeleteServiceTokenRequest
import zio.opensearch.security.delete_service_token.DeleteServiceTokenResponse
import zio.opensearch.security.delete_user.DeleteUserRequest
import zio.opensearch.security.delete_user.DeleteUserResponse
import zio.opensearch.security.disable_user.DisableUserRequest
import zio.opensearch.security.disable_user.DisableUserResponse
import zio.opensearch.security.disable_user_profile.DisableUserProfileRequest
import zio.opensearch.security.disable_user_profile.DisableUserProfileResponse
import zio.opensearch.security.enable_user.EnableUserRequest
import zio.opensearch.security.enable_user.EnableUserResponse
import zio.opensearch.security.enable_user_profile.EnableUserProfileRequest
import zio.opensearch.security.enable_user_profile.EnableUserProfileResponse
import zio.opensearch.security.enroll_kibana.EnrollKibanaRequest
import zio.opensearch.security.enroll_kibana.EnrollKibanaResponse
import zio.opensearch.security.enroll_node.EnrollNodeRequest
import zio.opensearch.security.enroll_node.EnrollNodeResponse
import zio.opensearch.security.get_api_key.GetApiKeyRequest
import zio.opensearch.security.get_api_key.GetApiKeyResponse
import zio.opensearch.security.get_builtin_privileges.GetBuiltinPrivilegesRequest
import zio.opensearch.security.get_builtin_privileges.GetBuiltinPrivilegesResponse
import zio.opensearch.security.get_privileges.GetPrivilegesRequest
import zio.opensearch.security.get_privileges.GetPrivilegesResponse
import zio.opensearch.security.get_role.GetRoleRequest
import zio.opensearch.security.get_role.GetRoleResponse
import zio.opensearch.security.get_role_mapping.GetRoleMappingRequest
import zio.opensearch.security.get_role_mapping.GetRoleMappingResponse
import zio.opensearch.security.get_service_accounts.GetServiceAccountsRequest
import zio.opensearch.security.get_service_accounts.GetServiceAccountsResponse
import zio.opensearch.security.get_service_credentials.GetServiceCredentialsRequest
import zio.opensearch.security.get_service_credentials.GetServiceCredentialsResponse
import zio.opensearch.security.get_token.GetTokenRequest
import zio.opensearch.security.get_token.GetTokenResponse
import zio.opensearch.security.get_user.GetUserRequest
import zio.opensearch.security.get_user.GetUserResponse
import zio.opensearch.security.get_user_privileges.GetUserPrivilegesRequest
import zio.opensearch.security.get_user_privileges.GetUserPrivilegesResponse
import zio.opensearch.security.get_user_profile.GetUserProfileRequest
import zio.opensearch.security.get_user_profile.GetUserProfileResponse
import zio.opensearch.security.grant_api_key.GrantApiKeyRequest
import zio.opensearch.security.grant_api_key.GrantApiKeyResponse
import zio.opensearch.security.has_privileges.HasPrivilegesRequest
import zio.opensearch.security.has_privileges.HasPrivilegesResponse
import zio.opensearch.security.has_privileges_user_profile.HasPrivilegesUserProfileRequest
import zio.opensearch.security.has_privileges_user_profile.HasPrivilegesUserProfileResponse
import zio.opensearch.security.invalidate_api_key.InvalidateApiKeyRequest
import zio.opensearch.security.invalidate_api_key.InvalidateApiKeyResponse
import zio.opensearch.security.invalidate_token.InvalidateTokenRequest
import zio.opensearch.security.invalidate_token.InvalidateTokenResponse
import zio.opensearch.security.oidc_authenticate.OidcAuthenticateRequest
import zio.opensearch.security.oidc_authenticate.OidcAuthenticateResponse
import zio.opensearch.security.oidc_logout.OidcLogoutRequest
import zio.opensearch.security.oidc_logout.OidcLogoutResponse
import zio.opensearch.security.oidc_prepare_authentication.OidcPrepareAuthenticationRequest
import zio.opensearch.security.oidc_prepare_authentication.OidcPrepareAuthenticationResponse
import zio.opensearch.security.put_privileges.PutPrivilegesRequest
import zio.opensearch.security.put_privileges.PutPrivilegesResponse
import zio.opensearch.security.put_role.PutRoleRequest
import zio.opensearch.security.put_role.PutRoleResponse
import zio.opensearch.security.put_role_mapping.PutRoleMappingRequest
import zio.opensearch.security.put_role_mapping.PutRoleMappingResponse
import zio.opensearch.security.put_user.PutUserRequest
import zio.opensearch.security.put_user.PutUserResponse
import zio.opensearch.security.query_api_keys.QueryApiKeysRequest
import zio.opensearch.security.query_api_keys.QueryApiKeysResponse
import zio.opensearch.security.requests._
import zio.opensearch.security.saml_authenticate.SamlAuthenticateRequest
import zio.opensearch.security.saml_authenticate.SamlAuthenticateResponse
import zio.opensearch.security.saml_complete_logout.SamlCompleteLogoutRequest
import zio.opensearch.security.saml_complete_logout.SamlCompleteLogoutResponse
import zio.opensearch.security.saml_invalidate.SamlInvalidateRequest
import zio.opensearch.security.saml_invalidate.SamlInvalidateResponse
import zio.opensearch.security.saml_logout.SamlLogoutRequest
import zio.opensearch.security.saml_logout.SamlLogoutResponse
import zio.opensearch.security.saml_prepare_authentication.SamlPrepareAuthenticationRequest
import zio.opensearch.security.saml_prepare_authentication.SamlPrepareAuthenticationResponse
import zio.opensearch.security.saml_service_provider_metadata.SamlServiceProviderMetadataRequest
import zio.opensearch.security.saml_service_provider_metadata.SamlServiceProviderMetadataResponse
import zio.opensearch.security.suggest_user_profiles.SuggestUserProfilesRequest
import zio.opensearch.security.suggest_user_profiles.SuggestUserProfilesResponse
import zio.opensearch.security.update_api_key.UpdateApiKeyRequest
import zio.opensearch.security.update_api_key.UpdateApiKeyResponse
import zio.opensearch.security.update_user_profile_data.UpdateUserProfileDataRequest
import zio.opensearch.security.update_user_profile_data.UpdateUserProfileDataResponse

object SecurityManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, SecurityManager] =
    ZLayer {
      for {
...
trait SecurityManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-activate-user-profile.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-change-password.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-clear-api-key-cache.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-clear-privilege-cache.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-clear-cache.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-create-api-key.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-delete-privilege.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-delete-role.html
   *
   * @param name Role name
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-delete-role-mapping.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-delete-user.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-disable-user.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/security-api-disable-user-profile.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-enable-user.html
   *
  ...
  /*
   * Allows a kibana instance to configure itself to communicate with a secured opensearch cluster.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/security-api-kibana-enrollment.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/security-api-node-enrollment.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-api-key.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
  ...
  /*
   * Retrieves the list of cluster privileges and index privileges that are available in this version of OpenSearch.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-builtin-privileges.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-privileges.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-role.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-role-mapping.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-service-accounts.html
   *
   * @param namespace An identifier for the namespace
   * @param service An identifier for the service name
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-service-credentials.html
   *
   * @param namespace An identifier for the namespace
   * @param service An identifier for the service name
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-token.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-user.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-user-privileges.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-get-user-profile.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-grant-api-key.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-has-privileges.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-invalidate-token.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-oidc-logout.html
   *
   * @param body body the body of the call
   */
  def oidcLogout(
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-oidc-prepare-authentication.html
   *
   * @param body body the body of the call
   */
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-put-role.html
   *
   * @param name Role name
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-put-role-mapping.html
   *
   * @param name Role-mapping name
   * @param body body the body of the call
   * @param refresh If `true` (the default) then refresh the affected shards to make this operation visible to search, if `wait_for` then wait for a refresh to make this operation visible to search, if `false` then do nothing with refreshes.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-put-user.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-query-api-key.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
  ...
  /*
   * Exchanges a SAML Response message for an OpenSearch access token and refresh token pair
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-saml-authenticate.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-saml-complete-logout.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-saml-invalidate.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-saml-logout.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-saml-prepare-authentication.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/security-api-saml-sp-metadata.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/security-api-suggest-user-profile.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
