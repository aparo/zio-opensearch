...
import zio.opensearch.ml.clear_trained_model_deployment_cache.ClearTrainedModelDeploymentCacheRequest
import zio.opensearch.ml.clear_trained_model_deployment_cache.ClearTrainedModelDeploymentCacheResponse
import zio.opensearch.ml.close_job.CloseJobRequest
import zio.opensearch.ml.close_job.CloseJobResponse
import zio.opensearch.ml.delete_calendar.DeleteCalendarRequest
import zio.opensearch.ml.delete_calendar.DeleteCalendarResponse
import zio.opensearch.ml.delete_calendar_event.DeleteCalendarEventRequest
import zio.opensearch.ml.delete_calendar_event.DeleteCalendarEventResponse
import zio.opensearch.ml.delete_calendar_job.DeleteCalendarJobRequest
import zio.opensearch.ml.delete_calendar_job.DeleteCalendarJobResponse
import zio.opensearch.ml.delete_data_frame_analytics.DeleteDataFrameAnalyticsRequest
import zio.opensearch.ml.delete_data_frame_analytics.DeleteDataFrameAnalyticsResponse
import zio.opensearch.ml.delete_datafeed.DeleteDatafeedRequest
import zio.opensearch.ml.delete_datafeed.DeleteDatafeedResponse
import zio.opensearch.ml.delete_expired_data.DeleteExpiredDataRequest
import zio.opensearch.ml.delete_expired_data.DeleteExpiredDataResponse
import zio.opensearch.ml.delete_filter.DeleteFilterRequest
import zio.opensearch.ml.delete_filter.DeleteFilterResponse
import zio.opensearch.ml.delete_forecast.DeleteForecastRequest
import zio.opensearch.ml.delete_forecast.DeleteForecastResponse
import zio.opensearch.ml.delete_job.DeleteJobRequest
import zio.opensearch.ml.delete_job.DeleteJobResponse
import zio.opensearch.ml.delete_model_snapshot.DeleteModelSnapshotRequest
import zio.opensearch.ml.delete_model_snapshot.DeleteModelSnapshotResponse
import zio.opensearch.ml.delete_trained_model.DeleteTrainedModelRequest
import zio.opensearch.ml.delete_trained_model.DeleteTrainedModelResponse
import zio.opensearch.ml.delete_trained_model_alias.DeleteTrainedModelAliasRequest
import zio.opensearch.ml.delete_trained_model_alias.DeleteTrainedModelAliasResponse
import zio.opensearch.ml.estimate_model_memory.EstimateModelMemoryRequest
import zio.opensearch.ml.estimate_model_memory.EstimateModelMemoryResponse
import zio.opensearch.ml.evaluate_data_frame.EvaluateDataFrameRequest
import zio.opensearch.ml.evaluate_data_frame.EvaluateDataFrameResponse
import zio.opensearch.ml.explain_data_frame_analytics.ExplainDataFrameAnalyticsRequest
import zio.opensearch.ml.explain_data_frame_analytics.ExplainDataFrameAnalyticsResponse
import zio.opensearch.ml.flush_job.FlushJobRequest
import zio.opensearch.ml.flush_job.FlushJobResponse
import zio.opensearch.ml.forecast.ForecastRequest
import zio.opensearch.ml.forecast.ForecastResponse
import zio.opensearch.ml.get_buckets.GetBucketsRequest
import zio.opensearch.ml.get_buckets.GetBucketsResponse
import zio.opensearch.ml.get_calendar_events.GetCalendarEventsRequest
import zio.opensearch.ml.get_calendar_events.GetCalendarEventsResponse
import zio.opensearch.ml.get_calendars.GetCalendarsRequest
import zio.opensearch.ml.get_calendars.GetCalendarsResponse
import zio.opensearch.ml.get_categories.GetCategoriesRequest
import zio.opensearch.ml.get_categories.GetCategoriesResponse
import zio.opensearch.ml.get_data_frame_analytics.GetDataFrameAnalyticsRequest
import zio.opensearch.ml.get_data_frame_analytics.GetDataFrameAnalyticsResponse
import zio.opensearch.ml.get_data_frame_analytics_stats.GetDataFrameAnalyticsStatsRequest
import zio.opensearch.ml.get_data_frame_analytics_stats.GetDataFrameAnalyticsStatsResponse
import zio.opensearch.ml.get_datafeed_stats.GetDatafeedStatsRequest
import zio.opensearch.ml.get_datafeed_stats.GetDatafeedStatsResponse
import zio.opensearch.ml.get_datafeeds.GetDatafeedsRequest
import zio.opensearch.ml.get_datafeeds.GetDatafeedsResponse
import zio.opensearch.ml.get_filters.GetFiltersRequest
import zio.opensearch.ml.get_filters.GetFiltersResponse
import zio.opensearch.ml.get_influencers.GetInfluencersRequest
import zio.opensearch.ml.get_influencers.GetInfluencersResponse
import zio.opensearch.ml.get_job_stats.GetJobStatsRequest
import zio.opensearch.ml.get_job_stats.GetJobStatsResponse
import zio.opensearch.ml.get_jobs.GetJobsRequest
import zio.opensearch.ml.get_jobs.GetJobsResponse
import zio.opensearch.ml.get_memory_stats.GetMemoryStatsRequest
import zio.opensearch.ml.get_memory_stats.GetMemoryStatsResponse
import zio.opensearch.ml.get_model_snapshot_upgrade_stats.GetModelSnapshotUpgradeStatsRequest
import zio.opensearch.ml.get_model_snapshot_upgrade_stats.GetModelSnapshotUpgradeStatsResponse
import zio.opensearch.ml.get_model_snapshots.GetModelSnapshotsRequest
import zio.opensearch.ml.get_model_snapshots.GetModelSnapshotsResponse
import zio.opensearch.ml.get_overall_buckets.GetOverallBucketsRequest
import zio.opensearch.ml.get_overall_buckets.GetOverallBucketsResponse
import zio.opensearch.ml.get_records.GetRecordsRequest
import zio.opensearch.ml.get_records.GetRecordsResponse
import zio.opensearch.ml.get_trained_models.GetTrainedModelsRequest
import zio.opensearch.ml.get_trained_models.GetTrainedModelsResponse
import zio.opensearch.ml.get_trained_models_stats.GetTrainedModelsStatsRequest
import zio.opensearch.ml.get_trained_models_stats.GetTrainedModelsStatsResponse
import zio.opensearch.ml.infer_trained_model.InferTrainedModelRequest
import zio.opensearch.ml.infer_trained_model.InferTrainedModelResponse
import zio.opensearch.ml.info.InfoRequest
import zio.opensearch.ml.info.InfoResponse
import zio.opensearch.ml.open_job.OpenJobRequest
import zio.opensearch.ml.open_job.OpenJobResponse
import zio.opensearch.ml.post_calendar_events.PostCalendarEventsRequest
import zio.opensearch.ml.post_calendar_events.PostCalendarEventsResponse
import zio.opensearch.ml.post_data.PostDataRequest
import zio.opensearch.ml.post_data.PostDataResponse
import zio.opensearch.ml.preview_data_frame_analytics.PreviewDataFrameAnalyticsRequest
import zio.opensearch.ml.preview_data_frame_analytics.PreviewDataFrameAnalyticsResponse
import zio.opensearch.ml.preview_datafeed.PreviewDatafeedRequest
import zio.opensearch.ml.preview_datafeed.PreviewDatafeedResponse
import zio.opensearch.ml.put_calendar.PutCalendarRequest
import zio.opensearch.ml.put_calendar.PutCalendarResponse
import zio.opensearch.ml.put_calendar_job.PutCalendarJobRequest
import zio.opensearch.ml.put_calendar_job.PutCalendarJobResponse
import zio.opensearch.ml.put_data_frame_analytics.PutDataFrameAnalyticsRequest
import zio.opensearch.ml.put_data_frame_analytics.PutDataFrameAnalyticsResponse
import zio.opensearch.ml.put_datafeed.PutDatafeedRequest
import zio.opensearch.ml.put_datafeed.PutDatafeedResponse
import zio.opensearch.ml.put_filter.PutFilterRequest
import zio.opensearch.ml.put_filter.PutFilterResponse
import zio.opensearch.ml.put_job.PutJobRequest
import zio.opensearch.ml.put_job.PutJobResponse
import zio.opensearch.ml.put_trained_model.PutTrainedModelRequest
import zio.opensearch.ml.put_trained_model.PutTrainedModelResponse
import zio.opensearch.ml.put_trained_model_alias.PutTrainedModelAliasRequest
import zio.opensearch.ml.put_trained_model_alias.PutTrainedModelAliasResponse
import zio.opensearch.ml.put_trained_model_definition_part.PutTrainedModelDefinitionPartRequest
import zio.opensearch.ml.put_trained_model_definition_part.PutTrainedModelDefinitionPartResponse
import zio.opensearch.ml.put_trained_model_vocabulary.PutTrainedModelVocabularyRequest
import zio.opensearch.ml.put_trained_model_vocabulary.PutTrainedModelVocabularyResponse
import zio.opensearch.ml.requests._
import zio.opensearch.ml.reset_job.ResetJobRequest
import zio.opensearch.ml.reset_job.ResetJobResponse
import zio.opensearch.ml.revert_model_snapshot.RevertModelSnapshotRequest
import zio.opensearch.ml.revert_model_snapshot.RevertModelSnapshotResponse
import zio.opensearch.ml.set_upgrade_mode.SetUpgradeModeRequest
import zio.opensearch.ml.set_upgrade_mode.SetUpgradeModeResponse
import zio.opensearch.ml.start_data_frame_analytics.StartDataFrameAnalyticsRequest
import zio.opensearch.ml.start_data_frame_analytics.StartDataFrameAnalyticsResponse
import zio.opensearch.ml.start_datafeed.StartDatafeedRequest
import zio.opensearch.ml.start_datafeed.StartDatafeedResponse
import zio.opensearch.ml.start_trained_model_deployment.StartTrainedModelDeploymentRequest
import zio.opensearch.ml.start_trained_model_deployment.StartTrainedModelDeploymentResponse
import zio.opensearch.ml.stop_data_frame_analytics.StopDataFrameAnalyticsRequest
import zio.opensearch.ml.stop_data_frame_analytics.StopDataFrameAnalyticsResponse
import zio.opensearch.ml.stop_datafeed.StopDatafeedRequest
import zio.opensearch.ml.stop_datafeed.StopDatafeedResponse
import zio.opensearch.ml.stop_trained_model_deployment.StopTrainedModelDeploymentRequest
import zio.opensearch.ml.stop_trained_model_deployment.StopTrainedModelDeploymentResponse
import zio.opensearch.ml.update_data_frame_analytics.UpdateDataFrameAnalyticsRequest
import zio.opensearch.ml.update_data_frame_analytics.UpdateDataFrameAnalyticsResponse
import zio.opensearch.ml.update_datafeed.UpdateDatafeedRequest
import zio.opensearch.ml.update_datafeed.UpdateDatafeedResponse
import zio.opensearch.ml.update_filter.UpdateFilterRequest
import zio.opensearch.ml.update_filter.UpdateFilterResponse
import zio.opensearch.ml.update_job.UpdateJobRequest
import zio.opensearch.ml.update_job.UpdateJobResponse
import zio.opensearch.ml.update_model_snapshot.UpdateModelSnapshotRequest
import zio.opensearch.ml.update_model_snapshot.UpdateModelSnapshotResponse
import zio.opensearch.ml.update_trained_model_deployment.UpdateTrainedModelDeploymentRequest
import zio.opensearch.ml.update_trained_model_deployment.UpdateTrainedModelDeploymentResponse
import zio.opensearch.ml.upgrade_job_snapshot.UpgradeJobSnapshotRequest
import zio.opensearch.ml.upgrade_job_snapshot.UpgradeJobSnapshotResponse
import zio.opensearch.ml.validate.ValidateRequest
import zio.opensearch.ml.validate.ValidateResponse
import zio.opensearch.ml.validate_detector.ValidateDetectorRequest
import zio.opensearch.ml.validate_detector.ValidateDetectorResponse

object MlManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, MlManager] =
    ZLayer {
      for {
...
trait MlManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-close-job.html
   *
  ...
  /*
   * Deletes a calendar.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-calendar.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-calendar-event.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/delete-dfanalytics.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-datafeed.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-expired-data.html
   *
  ...
  /*
   * Deletes a filter.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-filter.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-delete-snapshot.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/delete-trained-models-aliases.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-apis.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/evaluate-dfanalytics.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to http://www.elastic.co/guide/en/opensearch/reference/current/explain-dfanalytics.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-flush-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-bucket.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-calendar-event.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-calendar.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-dfanalytics-stats.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-datafeed-stats.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-datafeed.html
   *
  ...
  /*
   * Retrieves filters.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-filter.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-influencer.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-ml-memory.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-snapshot.html
   *
   * @param jobId The ID of the job to fetch
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-overall-buckets.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-get-record.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-trained-models.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-trained-models-stats.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/infer-trained-model.html
   *
   * @param modelId The unique identifier of the trained model.
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-ml-info.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-open-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-post-calendar-event.html
   *
   * @param calendarId The ID of the calendar to modify
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-post-data.html
   *
  ...
  /*
   * Previews a datafeed.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-preview-datafeed.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-put-calendar.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/put-dfanalytics.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-put-datafeed.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-put-filter.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-put-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/put-trained-models.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/put-trained-models-aliases.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/put-trained-model-definition-part.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/put-trained-model-vocabulary.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-reset-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-revert-snapshot.html
   *
   * @param jobId The ID of the job to fetch
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-set-upgrade-mode.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/start-dfanalytics.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-start-datafeed.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/start-trained-model-deployment.html
   *
   * @param modelId The unique identifier of the trained model.
   * @param priority
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/stop-dfanalytics.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-stop-datafeed.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/stop-trained-model-deployment.html
   *
   * @param modelId The unique identifier of the trained model.
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/update-dfanalytics.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-update-datafeed.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-update-filter.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-update-job.html
   *
   * @param jobId The ID of the job to create
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-update-trained-model-deployment.html
   *
   * @param modelId The unique identifier of the trained model.
   * @param body body the body of the call
   */
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/ml-upgrade-job-model-snapshot.html
   *
   * @param jobId The ID of the job
