...
import zio.opensearch.client.SnapshotActionResolver
import zio.opensearch.requests.snapshot._
import zio.opensearch.responses.snapshot._
...
object SnapshotService {
  ...
  val live: ZLayer[OpenSearchService, Nothing, SnapshotService] =
    ZLayer {
