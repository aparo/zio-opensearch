...
import zio.opensearch.rollup.delete_job.DeleteJobRequest
import zio.opensearch.rollup.delete_job.DeleteJobResponse
import zio.opensearch.rollup.get_jobs.GetJobsRequest
import zio.opensearch.rollup.get_jobs.GetJobsResponse
import zio.opensearch.rollup.get_rollup_caps.GetRollupCapsRequest
import zio.opensearch.rollup.get_rollup_caps.GetRollupCapsResponse
import zio.opensearch.rollup.get_rollup_index_caps.GetRollupIndexCapsRequest
import zio.opensearch.rollup.get_rollup_index_caps.GetRollupIndexCapsResponse
import zio.opensearch.rollup.put_job.PutJobRequest
import zio.opensearch.rollup.put_job.PutJobResponse
import zio.opensearch.rollup.requests.{ PutJobRequestBody, RollupSearchRequestBody }
import zio.opensearch.rollup.rollup_search.RollupSearchRequest
import zio.opensearch.rollup.rollup_search.RollupSearchResponse
import zio.opensearch.rollup.start_job.StartJobRequest
import zio.opensearch.rollup.start_job.StartJobResponse
import zio.opensearch.rollup.stop_job.StopJobRequest
import zio.opensearch.rollup.stop_job.StopJobResponse

object RollupManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, RollupManager] =
    ZLayer {
      for {
...
trait RollupManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-delete-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-get-rollup-caps.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-get-rollup-index-caps.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-put-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-search.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-start-job.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/rollup-stop-job.html
   *
