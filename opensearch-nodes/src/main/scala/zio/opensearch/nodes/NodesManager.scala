...
import zio.opensearch.nodes.clear_repositories_metering_archive.ClearRepositoriesMeteringArchiveRequest
import zio.opensearch.nodes.clear_repositories_metering_archive.ClearRepositoriesMeteringArchiveResponse
import zio.opensearch.nodes.get_repositories_metering_info.GetRepositoriesMeteringInfoRequest
import zio.opensearch.nodes.get_repositories_metering_info.GetRepositoriesMeteringInfoResponse
import zio.opensearch.nodes.hot_threads.HotThreadsRequest
import zio.opensearch.nodes.hot_threads.HotThreadsResponse
import zio.opensearch.nodes.info.InfoRequest
import zio.opensearch.nodes.info.InfoResponse
import zio.opensearch.nodes.reload_secure_settings.ReloadSecureSettingsRequest
import zio.opensearch.nodes.reload_secure_settings.ReloadSecureSettingsResponse
import zio.opensearch.nodes.requests.ReloadSecureSettingsRequestBody
import zio.opensearch.nodes.stats.StatsRequest
import zio.opensearch.nodes.stats.StatsResponse
import zio.opensearch.nodes.usage.UsageRequest
import zio.opensearch.nodes.usage.UsageResponse
import zio.opensearch.sort.Sort.Sort

object NodesManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, NodesManager] =
    ZLayer {
      for {
...
trait NodesManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/clear-repositories-metering-archive-api.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-repositories-metering-api.html
   *
