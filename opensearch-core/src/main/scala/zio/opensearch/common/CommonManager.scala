...
import zio.opensearch.common.bulk.{ BulkRequest, BulkResponse }
import zio.opensearch.common.clear_scroll.{ ClearScrollRequest, ClearScrollResponse }
import zio.opensearch.common.close_point_in_time.{ ClosePointInTimeRequest, ClosePointInTimeResponse }
import zio.opensearch.common.count.{ CountRequest, CountResponse }
import zio.opensearch.common.create.{ CreateRequest, CreateResponse }
import zio.opensearch.common.delete.{ DeleteRequest, DeleteResponse }
import zio.opensearch.common.delete_by_query.{ DeleteByQueryRequest, DeleteByQueryResponse }
import zio.opensearch.common.delete_by_query_rethrottle.{
  DeleteByQueryRethrottleRequest,
  DeleteByQueryRethrottleResponse
}
import zio.opensearch.common.delete_script.{ DeleteScriptRequest, DeleteScriptResponse }
import zio.opensearch.common.exists.{ ExistsRequest, ExistsResponse }
import zio.opensearch.common.exists_source.{ ExistsSourceRequest, ExistsSourceResponse }
import zio.opensearch.common.explain.{ ExplainRequest, ExplainResponse }
import zio.opensearch.common.field_caps.{ FieldCapsRequest, FieldCapsResponse }
import zio.opensearch.common.get.{ GetRequest, GetResponse }
import zio.opensearch.common.get_script.{ GetScriptRequest, GetScriptResponse }
import zio.opensearch.common.get_script_context.{ GetScriptContextRequest, GetScriptContextResponse }
import zio.opensearch.common.get_script_languages.{ GetScriptLanguagesRequest, GetScriptLanguagesResponse }
import zio.opensearch.common.get_source.{ GetSourceRequest, GetSourceResponse }
import zio.opensearch.common.index.{ IndexRequest, IndexResponse }
import zio.opensearch.common.info.{ InfoRequest, InfoResponse }
import zio.opensearch.common.knn_search.{ KnnSearchRequest, KnnSearchResponse }
import zio.opensearch.common.mget.{ MultiGetRequest, MultiGetResponse }
import zio.opensearch.common.msearch.{ MultiSearchRequest, MultiSearchResponse }
import zio.opensearch.common.msearch_template.{ MsearchTemplateRequest, MsearchTemplateResponse }
import zio.opensearch.common.mtermvectors.{ MultiTermVectorsRequest, MultiTermVectorsResponse }
import zio.opensearch.common.open_point_in_time.{ OpenPointInTimeRequest, OpenPointInTimeResponse }
import zio.opensearch.common.ping.{ PingRequest, PingResponse }
import zio.opensearch.common.put_script.{ PutScriptRequest, PutScriptResponse }
import zio.opensearch.common.rank_eval.{ RankEvalRequest, RankEvalResponse }
import zio.opensearch.common.reindex.{ ReindexRequest, ReindexResponse }
import zio.opensearch.common.reindex_rethrottle.{ ReindexRethrottleRequest, ReindexRethrottleResponse }
import zio.opensearch.common.render_search_template.{ RenderSearchTemplateRequest, RenderSearchTemplateResponse }
import zio.opensearch.common.requests._
import zio.opensearch.common.scripts_painless_execute.{ ScriptsPainlessExecuteRequest, ScriptsPainlessExecuteResponse }
import zio.opensearch.common.scroll.{ ScrollRequest, ScrollResponse }
import zio.opensearch.common.search.{ SearchRequest, SearchRequestBody, SearchResponse, SearchType }
import zio.opensearch.common.search_mvt.{ SearchMvtRequest, SearchMvtResponse }
import zio.opensearch.common.search_shards.{ SearchShardsRequest, SearchShardsResponse }
import zio.opensearch.common.search_template.{ SearchTemplateRequest, SearchTemplateResponse }
import zio.opensearch.common.semantic_search.{ SemanticSearchRequest, SemanticSearchResponse }
import zio.opensearch.common.terms_enum.{ TermsEnumRequest, TermsEnumResponse }
import zio.opensearch.common.termvectors.{ TermvectorsRequest, TermvectorsResponse }
import zio.opensearch.common.update.{ UpdateRequest, UpdateResponse }
import zio.opensearch.common.update_by_query.{ UpdateByQueryRequest, UpdateByQueryResponse }
import zio.opensearch.common.update_by_query_rethrottle.{
...
trait CommonManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/docs-bulk.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/clear-scroll-api.html
   *
   * @param scrollId
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-count.html
   *
   * @param index
...
Returns a 409 response when a document with a same ID already exists in the index.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-explain.html
   *
   * @param index The name of the index
   * @param id The document ID
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-field-caps.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/painless/master/painless-contexts.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/index.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/docs-multi-get.html
   *
   * @param body body the body of the call
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-multi-search.html
   *
   * @param index
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/search-multi-search.html
   *
   * @param index
...
documents from a remote cluster.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/docs-reindex.html
   *
   * @param requireAlias
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/render-search-template-api.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-request-body.html#request-body-search-scroll
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
...
@server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-vector-tile-api.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/search-shards.html
   *
   * @param index
  ...
  /*
   * Allows to use the Mustache language to pre-render a search definition.
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/search-template.html
   *
   * @param index Comma-separated list of data streams, indices,
   * and aliases to search. Supports wildcards (*).
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/search-terms-enum.html
   *
   * @param indices A comma-separated list of index names to search; use `_all` or empty string to perform the operation on all indices
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/docs-termvectors.html
   *
   * @param index The index in which the document resides.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/docs-update.html
   *
   * @param index The name of the index
   * @param id Document ID
   * @param body body the body of the call
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/docs-update-by-query.html
   *
   * @param indices A comma-separated list of index names to search; use `_all` or empty string to perform the operation on all indices
   * @param taskId
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/docs-update-by-query.html
   *
   * @param requestsPerSecond The throttle to set on this request in floating sub-requests per second. -1 means set no throttle.
   * @param taskId The task id to rethrottle
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
