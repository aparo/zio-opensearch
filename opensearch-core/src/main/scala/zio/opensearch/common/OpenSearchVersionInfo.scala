...
final case class OpenSearchVersionInfo(
...
object OpenSearchVersionInfo {
  implicit lazy val jsonCodec: JsonCodec[OpenSearchVersionInfo] =
    DeriveJsonCodec.gen[OpenSearchVersionInfo]
}
