...
package zio.opensearch.cluster
...
import zio.opensearch.cluster.allocation_explain.AllocationExplainRequest
import zio.opensearch.cluster.allocation_explain.AllocationExplainResponse
import zio.opensearch.cluster.delete_component_template.DeleteComponentTemplateRequest
import zio.opensearch.cluster.delete_component_template.DeleteComponentTemplateResponse
import zio.opensearch.cluster.delete_voting_config_exclusions.DeleteVotingConfigExclusionsRequest
import zio.opensearch.cluster.delete_voting_config_exclusions.DeleteVotingConfigExclusionsResponse
import zio.opensearch.cluster.exists_component_template.ExistsComponentTemplateRequest
import zio.opensearch.cluster.exists_component_template.ExistsComponentTemplateResponse
import zio.opensearch.cluster.get_component_template.GetComponentTemplateRequest
import zio.opensearch.cluster.get_component_template.GetComponentTemplateResponse
import zio.opensearch.cluster.get_settings.GetSettingsRequest
import zio.opensearch.cluster.get_settings.GetSettingsResponse
import zio.opensearch.cluster.health.HealthRequest
import zio.opensearch.cluster.health.HealthResponse
import zio.opensearch.cluster.pending_tasks.PendingTasksRequest
import zio.opensearch.cluster.pending_tasks.PendingTasksResponse
import zio.opensearch.cluster.post_voting_config_exclusions.PostVotingConfigExclusionsRequest
import zio.opensearch.cluster.post_voting_config_exclusions.PostVotingConfigExclusionsResponse
import zio.opensearch.cluster.put_component_template.PutComponentTemplateRequest
import zio.opensearch.cluster.put_component_template.PutComponentTemplateResponse
import zio.opensearch.cluster.put_settings.PutSettingsRequest
import zio.opensearch.cluster.put_settings.PutSettingsResponse
import zio.opensearch.cluster.remote_info.RemoteInfoRequest
import zio.opensearch.cluster.remote_info.RemoteInfoResponse
import zio.opensearch.cluster.requests.{
  AllocationExplainRequestBody,
  PutComponentTemplateRequestBody,
  PutSettingsRequestBody,
  RerouteRequestBody
}
import zio.opensearch.cluster.reroute.RerouteRequest
import zio.opensearch.cluster.reroute.RerouteResponse
import zio.opensearch.cluster.state.StateRequest
import zio.opensearch.cluster.state.StateResponse
import zio.opensearch.cluster.stats.StatsRequest
import zio.opensearch.cluster.stats.StatsResponse

object ClusterManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, ClusterManager] =
    ZLayer {
      for {
...
trait ClusterManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/indices-component-template.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/voting-config-exclusions.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
...
@server_default false
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/cluster-get-settings.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
