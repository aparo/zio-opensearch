...
import zio.opensearch.snapshot.cleanup_repository.CleanupRepositoryRequest
import zio.opensearch.snapshot.cleanup_repository.CleanupRepositoryResponse
import zio.opensearch.snapshot.clone.CloneRequest
import zio.opensearch.snapshot.clone.CloneResponse
import zio.opensearch.snapshot.create.CreateRequest
import zio.opensearch.snapshot.create.CreateResponse
import zio.opensearch.snapshot.create_repository.CreateRepositoryRequest
import zio.opensearch.snapshot.create_repository.CreateRepositoryResponse
import zio.opensearch.snapshot.delete.DeleteRequest
import zio.opensearch.snapshot.delete.DeleteResponse
import zio.opensearch.snapshot.delete_repository.DeleteRepositoryRequest
import zio.opensearch.snapshot.delete_repository.DeleteRepositoryResponse
import zio.opensearch.snapshot.get.GetRequest
import zio.opensearch.snapshot.get.GetResponse
import zio.opensearch.snapshot.get_repository.GetRepositoryRequest
import zio.opensearch.snapshot.get_repository.GetRepositoryResponse
import zio.opensearch.snapshot.repository_analyze.RepositoryAnalyzeRequest
import zio.opensearch.snapshot.repository_analyze.RepositoryAnalyzeResponse
import zio.opensearch.snapshot.requests.{
  CloneRequestBody,
  CreateRepositoryRequestBody,
  CreateRequestBody,
  RestoreRequestBody
}
import zio.opensearch.snapshot.restore.RestoreRequest
import zio.opensearch.snapshot.restore.RestoreResponse
import zio.opensearch.snapshot.status.StatusRequest
import zio.opensearch.snapshot.status.StatusResponse
import zio.opensearch.snapshot.verify_repository.VerifyRepositoryRequest
import zio.opensearch.snapshot.verify_repository.VerifyRepositoryResponse

object SnapshotManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, SnapshotManager] =
    ZLayer {
      for {
...
trait SnapshotManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/clean-up-snapshot-repo-api.html
   *
