...
import zio.opensearch.shutdown.delete_node.DeleteNodeRequest
import zio.opensearch.shutdown.delete_node.DeleteNodeResponse
import zio.opensearch.shutdown.get_node.GetNodeRequest
import zio.opensearch.shutdown.get_node.GetNodeResponse
import zio.opensearch.shutdown.put_node.PutNodeRequest
import zio.opensearch.shutdown.put_node.PutNodeResponse

object ShutdownManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, ShutdownManager] =
    ZLayer {
      for {
