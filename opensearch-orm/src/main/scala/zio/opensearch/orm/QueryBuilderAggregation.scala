...
import zio.opensearch.orm.GroupByOperator.GroupByOperator
import zio.opensearch.responses.aggregations
import zio.opensearch.responses.aggregations.MetricValue
...
trait MetricGroupByAggregation extends AggGroupByAggregation {
  ...
  def getValue(value: zio.opensearch.responses.aggregations.Aggregation): Json
}
