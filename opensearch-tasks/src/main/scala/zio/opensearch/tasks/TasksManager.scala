...
import zio.opensearch.tasks.cancel.CancelRequest
import zio.opensearch.tasks.cancel.CancelResponse
import zio.opensearch.tasks.get.GetRequest
import zio.opensearch.tasks.get.GetResponse
import zio.opensearch.tasks.list.ListRequest
import zio.opensearch.tasks.list.ListResponse

object TasksManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, TasksManager] =
    ZLayer {
      for {
