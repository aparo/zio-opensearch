...
import zio.opensearch.enrich.delete_policy.DeletePolicyRequest
import zio.opensearch.enrich.delete_policy.DeletePolicyResponse
import zio.opensearch.enrich.execute_policy.ExecutePolicyRequest
import zio.opensearch.enrich.execute_policy.ExecutePolicyResponse
import zio.opensearch.enrich.get_policy.GetPolicyRequest
import zio.opensearch.enrich.get_policy.GetPolicyResponse
import zio.opensearch.enrich.put_policy.PutPolicyRequest
import zio.opensearch.enrich.put_policy.PutPolicyResponse
import zio.opensearch.enrich.stats.StatsRequest
import zio.opensearch.enrich.stats.StatsResponse

object EnrichManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, EnrichManager] =
    ZLayer {
      for {
...
trait EnrichManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/delete-enrich-policy-api.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/execute-enrich-policy-api.html
   *
   * @param name The name of the enrich policy
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/get-enrich-policy-api.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/put-enrich-policy-api.html
   *
   * @param name The name of the enrich policy
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/enrich-stats-api.html
   *
   * @param errorTrace When set to `true` OpenSearch will include the full stack trace of errors
   * when they occur.
   * @server_default false
