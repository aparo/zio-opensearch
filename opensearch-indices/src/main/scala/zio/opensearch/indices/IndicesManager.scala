...
import zio.opensearch.indices.add_block.AddBlockRequest
import zio.opensearch.indices.add_block.AddBlockResponse
import zio.opensearch.indices.analyze.AnalyzeRequest
import zio.opensearch.indices.analyze.AnalyzeResponse
import zio.opensearch.indices.clear_cache.ClearCacheRequest
import zio.opensearch.indices.clear_cache.ClearCacheResponse
import zio.opensearch.indices.clone.CloneRequest
import zio.opensearch.indices.clone.CloneResponse
import zio.opensearch.indices.close.CloseRequest
import zio.opensearch.indices.close.CloseResponse
import zio.opensearch.indices.create.CreateRequest
import zio.opensearch.indices.create.CreateResponse
import zio.opensearch.indices.create_data_stream.CreateDataStreamRequest
import zio.opensearch.indices.create_data_stream.CreateDataStreamResponse
import zio.opensearch.indices.data_streams_stats.DataStreamsStatsRequest
import zio.opensearch.indices.data_streams_stats.DataStreamsStatsResponse
import zio.opensearch.indices.delete.DeleteRequest
import zio.opensearch.indices.delete.DeleteResponse
import zio.opensearch.indices.delete_alias.DeleteAliasRequest
import zio.opensearch.indices.delete_alias.DeleteAliasResponse
import zio.opensearch.indices.delete_data_stream.DeleteDataStreamRequest
import zio.opensearch.indices.delete_data_stream.DeleteDataStreamResponse
import zio.opensearch.indices.delete_index_template.DeleteIndexTemplateRequest
import zio.opensearch.indices.delete_index_template.DeleteIndexTemplateResponse
import zio.opensearch.indices.delete_template.DeleteTemplateRequest
import zio.opensearch.indices.delete_template.DeleteTemplateResponse
import zio.opensearch.indices.disk_usage.DiskUsageRequest
import zio.opensearch.indices.disk_usage.DiskUsageResponse
import zio.opensearch.indices.downsample.DownsampleRequest
import zio.opensearch.indices.downsample.DownsampleResponse
import zio.opensearch.indices.exists.ExistsRequest
import zio.opensearch.indices.exists_alias.ExistsAliasRequest
import zio.opensearch.indices.exists_index_template.ExistsIndexTemplateRequest
import zio.opensearch.indices.exists_index_template.ExistsIndexTemplateResponse
import zio.opensearch.indices.exists_template.ExistsTemplateRequest
import zio.opensearch.indices.exists_template.ExistsTemplateResponse
import zio.opensearch.indices.field_usage_stats.FieldUsageStatsRequest
import zio.opensearch.indices.field_usage_stats.FieldUsageStatsResponse
import zio.opensearch.indices.flush.FlushRequest
import zio.opensearch.indices.flush.FlushResponse
import zio.opensearch.indices.forcemerge.ForcemergeRequest
import zio.opensearch.indices.forcemerge.ForcemergeResponse
import zio.opensearch.indices.get.{ GetRequest, GetResponse }
import zio.opensearch.indices.get_alias.GetAliasRequest
import zio.opensearch.indices.get_alias.GetAliasResponse
import zio.opensearch.indices.get_data_stream.GetDataStreamRequest
import zio.opensearch.indices.get_data_stream.GetDataStreamResponse
import zio.opensearch.indices.get_field_mapping.GetFieldMappingRequest
import zio.opensearch.indices.get_field_mapping.GetFieldMappingResponse
import zio.opensearch.indices.get_index_template.GetIndexTemplateRequest
import zio.opensearch.indices.get_index_template.GetIndexTemplateResponse
import zio.opensearch.indices.get_mapping.GetMappingRequest
import zio.opensearch.indices.get_mapping.GetMappingResponse
import zio.opensearch.indices.get_settings.GetSettingsRequest
import zio.opensearch.indices.get_settings.GetSettingsResponse
import zio.opensearch.indices.get_template.GetTemplateRequest
import zio.opensearch.indices.get_template.GetTemplateResponse
import zio.opensearch.indices.migrate_to_data_stream.MigrateToDataStreamRequest
import zio.opensearch.indices.migrate_to_data_stream.MigrateToDataStreamResponse
import zio.opensearch.indices.modify_data_stream.ModifyDataStreamRequest
import zio.opensearch.indices.modify_data_stream.ModifyDataStreamResponse
import zio.opensearch.indices.open.OpenRequest
import zio.opensearch.indices.open.OpenResponse
import zio.opensearch.indices.promote_data_stream.PromoteDataStreamRequest
import zio.opensearch.indices.promote_data_stream.PromoteDataStreamResponse
import zio.opensearch.indices.put_alias.PutAliasRequest
import zio.opensearch.indices.put_alias.PutAliasResponse
import zio.opensearch.indices.put_index_template.PutIndexTemplateRequest
import zio.opensearch.indices.put_index_template.PutIndexTemplateResponse
import zio.opensearch.indices.put_mapping.PutMappingRequest
import zio.opensearch.indices.put_mapping.PutMappingResponse
import zio.opensearch.indices.put_settings.PutSettingsRequest
import zio.opensearch.indices.put_settings.PutSettingsResponse
import zio.opensearch.indices.put_template.PutTemplateRequest
import zio.opensearch.indices.put_template.PutTemplateResponse
import zio.opensearch.indices.recovery.RecoveryRequest
import zio.opensearch.indices.RecoveryResponse
import zio.opensearch.indices.refresh.RefreshRequest
import zio.opensearch.indices.refresh.RefreshResponse
import zio.opensearch.indices.reload_search_analyzers.ReloadSearchAnalyzersRequest
import zio.opensearch.indices.reload_search_analyzers.ReloadSearchAnalyzersResponse
import zio.opensearch.indices.requests._
import zio.opensearch.indices.resolve_index.ResolveIndexRequest
import zio.opensearch.indices.resolve_index.ResolveIndexResponse
import zio.opensearch.indices.rollover.RolloverRequest
import zio.opensearch.indices.rollover.RolloverResponse
import zio.opensearch.indices.segments.SegmentsRequest
import zio.opensearch.indices.segments.SegmentsResponse
import zio.opensearch.indices.shard_stores.ShardStoresRequest
import zio.opensearch.indices.shard_stores.ShardStoresResponse
import zio.opensearch.indices.shrink.ShrinkRequest
import zio.opensearch.indices.shrink.ShrinkResponse
import zio.opensearch.indices.simulate_index_template.SimulateIndexTemplateRequest
import zio.opensearch.indices.simulate_index_template.SimulateIndexTemplateResponse
import zio.opensearch.indices.simulate_template.SimulateTemplateRequest
import zio.opensearch.indices.simulate_template.SimulateTemplateResponse
import zio.opensearch.indices.split.SplitRequest
import zio.opensearch.indices.split.SplitResponse
import zio.opensearch.indices.stats.StatsRequest
import zio.opensearch.indices.stats.StatsResponse
import zio.opensearch.indices.update_aliases.UpdateAliasesRequest
import zio.opensearch.indices.update_aliases.UpdateAliasesResponse
import zio.opensearch.indices.validate_query.ValidateQueryRequest
import zio.opensearch.indices.validate_query.ValidateQueryResponse

object IndicesManager {
  lazy val live: ZLayer[OpenSearchHttpService, Nothing, IndicesManager] =
    ZLayer {
      for {
...
trait IndicesManager {
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/index-modules-blocks.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/indices-disk-usage.html
   *
  ...
  /*
   * Downsample an index
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/current/xpack-rollup.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/field-usage-stats.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/indices-reload-analyzers.html
   *
   ...
   * For more info refers to https://www.elastic.co/guide/en/opensearch/reference/master/indices-resolve-index-api.html
   *
